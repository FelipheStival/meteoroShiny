#========================================================================
# Arquivo que contem o boot da aplicacao
#========================================================================

# Metodo para carregar os pacotes necessarias para a aplicacao
boot.loadPackages <- function(){
...
# Metodo para carregar as labels da tela de login
boot.loadLabels <- function(){
...
# Carregando os modulos da aplicacao
boot.LoadModules = function() {
