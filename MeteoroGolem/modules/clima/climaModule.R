  ...
  div(
    ...
    dashboardPage(
      ...
      dashboardBody(
        ...
        clima.Tabela(),
        clima.graficoBasico(),
        clima.grafico.matriz(),
        clima.grafico.precipitacao(),
        clima.grafico.cumulativa(),
        clima.grafico.secoUmido(),
        clima.grafico.periodoChuvoso(),
        clima.grafico.Temperatura(),
        clima.grafico.anomaliaPrecipitacao(),
